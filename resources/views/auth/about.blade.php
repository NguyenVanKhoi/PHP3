            ...
            <div class="row justify-content-between">
                <div class="col-lg-5">
                    <div class="intro-excerpt">
                        ...
                        <p><a href="{{ route('auth.shop') }}" class="btn btn-secondary me-2">Shop Now</a></p>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="hero-img-wrap">
                        <img src="{{ asset('auth/images') }}/2-30-removebg-preview.png" class="img-profile">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('auth/images') }}/person_1.jpg" class="img-fluid mb-5">
                ...
                <!-- Start Column 2 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('auth/images') }}/person_2.jpg" class="img-fluid mb-5">
                ...
                <!-- Start Column 3 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('auth/images') }}/person_3.jpg" class="img-fluid mb-5">
                ...
                <!-- Start Column 4 -->
                <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
                    <img src="{{ asset('auth/images') }}/person_4.jpg" class="img-fluid mb-5">
