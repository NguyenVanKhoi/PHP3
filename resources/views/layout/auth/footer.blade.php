...
<footer class="footer-section">
    <div class="container relative">
        ...
        <div class="sofa-img">
            <img src="{{ asset('auth/images') }}/logo1.png" alt="Image" class="img-fluid">
        </div>
            ...
            <div class="col-lg-8">
                <div class="subscription-form">
                    <h3 class="d-flex align-items-center"><span class="me-1"><img
                                src="{{ asset('auth/images') }}/envelope-outline.svg" alt="Image"
        ...
        <div class="row g-5 mb-5">
            <div class="col-lg-4">
                <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">BonneyShop</a></div>
...
<script src="{{ asset('auth/js/tiny-slider.js') }}"></script>
